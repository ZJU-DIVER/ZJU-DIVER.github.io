...
Jinfei Liu is a ZJU100 Young Professor of Computer Science at Zhejiang University. His research interests lie in data markets. He has published over 60 papers and received the CCS 2024 Distinguished Paper Award. He has served and serves as associate editor for ACM TKDD and ACM AILET, and program committee member regularly for VLDB, SIGMOD, and ICDE.
...
Yihao Zheng,  **Jinfei Liu**\*, Kui Ren, and Li Xiong. B^2Mark: A Blind and Buyer-Traceable Watermarking Scheme for Tabular Datasets. SIGMOD 2026. (CCF A)

Li Peng, Jiayao Zhang, Yihang Wu, Weiran Liu,  **Jinfei Liu**\*, Zheng Yan, Kui Ren, Lei Zhang, and Lin Qu. Reliable and Private Utility Signaling for Data Markets. SIGMOD 2026. (CCF A)
...
Fan Mo, Bo Liu, Yuan Fan, Kun Qin, Yizhou Zhao, Jinhe Zhou, Jia Sun, **Jinfei Liu**, and Kui Ren. DataSIR: A Benchmark Dataset for Sensitive Information Recognition. NeurIPS 2025. (CCF A)

Shang Liu, Yang Cao, Takao Murakami, Weiran Liu, Pei Liew, Tsubasa Takahash,  **Jinfei Liu**\*, and Masatoshi Yoshikawa. Federated Graph Analytics with Differential Privacy. TDSC 2025. (CCF A)
...
Haocheng Xia, Xiang Li, Junyuan Pang, **Jinfei Liu**\*, Kui Ren, and Li Xiong, P-Shapley: Shapley Values on Probabilistic Classifiers. VLDB 2024. (CCF A)
...
------We design a faster skyline algorithm that has not been improved in the past 29 years from a theoretical perspective.
